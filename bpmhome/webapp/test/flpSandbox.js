		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdevcomaubpmhome-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdevcomaubpmhome-display": {
								"semanticObject": "comdevcomaubpmhome",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dev.comau.bpmhome",
									"url": sap.ui.require.toUrl("com/dev/comau/bpmhome")
								}
							}
						}
					}
